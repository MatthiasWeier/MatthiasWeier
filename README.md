# It's me, the guy in the picture! :)

![Profile Views](https://komarev.com/ghpvc/?username=MatthiasWeier&color=blue&style=plastic)

### What I'm currently up to:
* **Learning DevOps:** Building a fully automated, production-ready cloud environment from scratch.
* **Learning & Applying:** Infrastructure as Code (Terraform), secure networking, and reverse proxies.
* **Latest Project:** Check out my [remote-devops-lab](https://github.com/MatthiasWeier/remote-devops-lab) where I provision Oracle Cloud Infrastructure entirely via code.
...
![Oracle Cloud](https://img.shields.io/badge/Oracle_Cloud-F80000.svg?&style=flat-square&logo=oracle&logoColor=white)
